...
let posts = [initialPost1, initialPost2];
...
app.get("/posts/:postTitle", (req, res)=>{
  ...
  posts.forEach((elem)=>{
    if(_.lowerCase(elem.postTitle) === _.lowerCase(req.params.postTitle)){
      
      res.render("post", {postTitle : elem.postTitle, postBody : elem.postBody})
